...
class SecurityHeaders
{
    ...
    public function handle(Request $request, Closure $next): Response
    {
        ...
        $response->headers->set('Content-Security-Policy', "default-src 'self'; connect-src 'self' https://www.google.com/recaptcha/; script-src 'self' 'unsafe-inline' https://www.google.com/recaptcha/ https://www.gstatic.com/recaptcha/ https://static.cloudflareinsights.com; style-src 'self' 'unsafe-inline'; frame-src https://www.google.com/recaptcha/ https://www.google.com/recaptcha/api2/");
